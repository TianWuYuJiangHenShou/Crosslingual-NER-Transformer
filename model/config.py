...
class Config():
    def __init__(self, args, load=True):
        ...
        self.filename_trimmed = "data/{}/glove_trimmed.npz".format(self.data_dir)
        self.use_pretrained = True

        # dataset
        self.filename_dev = "data/{}/dev.txt".format(self.data_dir)
        self.filename_test = "data/{}/test.txt".format(self.data_dir)
        self.filename_train = "data/{}/train.txt".format(self.data_dir)


        self.max_iter = None  # if not None, max number of examples in Dataset

        # vocab (created from dataset with build_data.py)
        self.filename_words = "data/{}/words.txt".format(self.data_dir)
        self.filename_tags = "data/{}/tags.txt".format(self.data_dir)
        self.filename_chars = "data/{}/chars.txt".format(self.data_dir)
